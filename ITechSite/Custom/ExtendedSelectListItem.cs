...
namespace ITechSite.Custom
{
    ...
    public static partial class HtmlHelperExtensions
    {
        ...
        public static MvcHtmlString ExtendedDropDownListFor(this HtmlHelper htmlHelper,string name, IEnumerable<ExtendedSelectListItem> selectList, string optionLabel, object htmlAttributes)
        {
            return SelectInternal(htmlHelper, optionLabel, name, selectList, false /* allowMultiple */, HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes));
        } 

        //public static MvcHtmlString ExtendedDropDownList<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, string name, IEnumerable<ExtendedSelectListItem> selectList, string optionLabel, object htmlAttributes)
        //{
        //    return SelectInternal(htmlHelper, optionLabel, name, selectList, false /* allowMultiple */, HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes));
        //}
